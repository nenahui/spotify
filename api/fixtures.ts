...
const run = async () => {
  ...
  const [ulukmanapo, macan, bakr] = await Artist.create(
    ...
    {
      name: 'De Lacure',
      picture: 'fixtures/delcaure.png',
      information:
        'Ануар Баймухаев – казахстанский рэп-исполнитель, автор песен. Он классический представитель казахского нью-скула, чье творчество сходно с творчеством Baller`а, HiRO и других исполнителей. Рэп-артист приложил много усилий, чтобы сделать свою музыку и речитативы профессиональными, качественными, «заносчивыми», проникновенными. И ему это удалось. Зрители уходят после его выступлений наполненными глубокими чувствами, смыслами, которые несут его песни. Гонорар может меняться в зависимости от логистики и райдера. Оставьте заявку, мы рассчитаем его для вашего ивента.',
    },
    {
      name: 'Macan',
